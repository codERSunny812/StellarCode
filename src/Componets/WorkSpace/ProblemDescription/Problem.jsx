...
const problemsMapping= {
  ...
  "best-time-to-buy-and-sell-stock":{...BestTimeToSelStock,difficulty:"easy"},
  "maximum-depth-of-binary-tree":{...MaxiDepthOfBT,difficulty:"easy"},
  "container-with-most-water":{...ContainerWithMostWater,difficulty:"medium"},
...
const Problem = () => {
  ...
  const colorOfQuestion =
    difficulty === 'easy' ? 'green' : difficulty === 'medium' ? 'yellow' : difficulty === 'hard' ? 'red' : 'black';
        ...
        <div className="">
          ...
          <div className="bottom h-screen overflow-y-auto overflow-scroll  bg-[#282828] pt-3  ">
            ...
            <div className=" flex items-center justify-start px-2 py-1 mx-2 my-1">
              <h1 className={`bg-[#3E3D3D] text-${colorOfQuestion}  font-bold capitalize px-2 py-[2px] rounded-full mx-2`}>
                {difficulty}
              </h1>
            ...
            <div className="examples  mx-2 my-1 capitalize">
              {/* example 1 */}
              {
                examples.map((examples)=>(
                  <>
                 <div key={examples.id}>
                  <h1 className="px-3 my-4 font-bold">example {examples.id}</h1>
