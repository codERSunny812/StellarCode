...
const Section1 = () => {
    return (
        <>
            <div className=" section1 flex p-12   justify-between">
                ...
                <div className="section1_content text  flex flex-col  justify-center items-center capitalize">
                    ...
                    <button className="bg-[#17807d] px-3 py-2 m-5 rounded-full capitalize text-white hover:bg-[#0d4c4b] cursor-pointer ">
...
const Section2 = () => {
    return (
        <>
            ...
            <div className=" section2 flex items-center justify-center">
                {/* section 2 text */}
                <div className="section2_contents">
                    ...
                    <div className="section2_para_content">
                        ...
                        <p className="section2_text_para w-[530px] h-[74px] text-center ">Explore is a well-organized tool that helps you get the most out of LeetCode by providing structure to guide your progress towards the next step in your programming career.</p>

                        <h4 className="w-[537px] h-[28px] capitalize text-end text-blue-500 font-bold section2_text_h4">get started </h4>
    ...
    return (
        ...
        <>
            ...
            <div className=" section3 flex flex-col justify-center items-center">
                ...
                <Lottie animationData={codingScreen} className=" section3_animation w-[900px] h-[300px]" />
